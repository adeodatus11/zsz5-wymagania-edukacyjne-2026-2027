...
.topbar-inner{max-width:1180px;margin:0 auto;padding:9px 18px;display:flex;gap:7px;flex-wrap:nowrap;overflow-x:auto;scrollbar-gutter:stable;-webkit-overflow-scrolling:touch}
.nav-link,.btn{display:inline-flex;align-items:center;justify-content:center;min-height:32px;padding:6px 10px;border-radius:999px;text-decoration:none;font-size:.8rem;font-weight:850;white-space:nowrap;flex:0 0 auto}
...
<nav class="topbar" aria-label="Nawigacja">
  <div class="topbar-inner">
    {nav}
    <a class="nav-link primary" href="katalog_podstaw_programowych_ZSZ5_2026_2027.html">Katalog podstaw</a>
  </div>
</nav>
...
<section class="section">
  ...
  <div class="cards">
    ...
    <div class="card">
      ...
      <p>Prawidłowo przygotowany rozkład umożliwia nauczycielowi zastępującemu kontynuowanie materiału w razie choroby lub nieprzewidzianej nieobecności nauczyciela prowadzącego.</p>
    </div>
  </div>
  <div class="callout warning">
    <h4>Termin przygotowania</h4>
    <p>Rozkład materiału należy przygotować do 1 września 2026 r. Do dziennika elektronicznego nie należy wprowadzać nowych rozkładów przed 30 sierpnia 2026 r., ponieważ w sobotę 29 sierpnia 2026 r. dotychczasowe rozkłady zostaną usunięte w ramach porządkowania dziennika. Do piątku 28 sierpnia 2026 r. należy przygotować plik lub własną roboczą wersję rozkładu poza dziennikiem, aby po 30 sierpnia wprowadzić go do uporządkowanego dziennika i od 1 września rozpocząć pracę bez przenoszenia starych danych.</p>
  </div>
</section>
<section class="section">
...
<section class="section">
  ...
  <p>Sekcja jest w przygotowaniu. Ramowe plany nauczania zostaną opublikowane po uporządkowaniu i zatwierdzeniu materiałów dla roku szkolnego 2026/2027.</p>
  <div class="callout">
...
<section class="section">
  ...
  <p>Sekcja jest w przygotowaniu. Szkolne zestawy programów nauczania zostaną opublikowane po uporządkowaniu i zatwierdzeniu materiałów dla roku szkolnego 2026/2027.</p>
  <div class="callout">
    <h4>W przygotowaniu</h4>
...
<section class="section">
  ...
  <div class="cards resource-grid">
    <div class="card"><h4>Katalog podstaw programowych ZSZ5</h4><p>Bezpośrednie linki do podstaw programowych w ZPE oraz zawodowe.edu.pl, uporządkowane według typu szkoły, obszaru, przedmiotu i zawodu.</p><a class="btn primary" href="katalog_podstaw_programowych_ZSZ5_2026_2027.html">Otwórz katalog</a></div>
    ...
    <div class="card"><h4>ZPE - podstawa programowa</h4><p>Aktualny punkt wejścia do podstaw programowych dla typów szkół i przedmiotów ogólnokształcących.</p><a class="btn" href="https://zpe.gov.pl/podstawa-programowa" target="_blank" rel="noopener">Otwórz ZPE</a></div>
    <div class="card"><h4>zawodowe.edu.pl - kwalifikacje w zawodzie</h4><p>Lista kwalifikacji zawodowych z podstronami efektów kształcenia i linkami do podstaw programowych zawodów.</p><a class="btn" href="https://zawodowe.edu.pl/kwalifikacje-w-zawodzie/" target="_blank" rel="noopener">Otwórz kwalifikacje</a></div>
...
def pages() -> list[Page]:
    return [
        ...
        Page(
            ...
            "Zebrane źródła umożliwiają sprawdzenie podstaw programowych, przygotowanie rozkładu materiału i uporządkowanie wymagań edukacyjnych.",
            MATERIALS_BODY,
        ),
        Page(
